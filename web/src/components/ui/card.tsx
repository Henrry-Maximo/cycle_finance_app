...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        'group/card bg-card text-card-foreground ring-foreground/10 border-background hover:border-border flex flex-col gap-4 overflow-hidden rounded-none border-2 py-4 text-xs/relaxed ring-1 transition-all hover:border-2 has-data-[slot=card-footer]:pb-0 has-[>img:first-child]:pt-0 data-[size=sm]:gap-2 data-[size=sm]:py-3 data-[size=sm]:has-data-[slot=card-footer]:pb-0 *:[img:first-child]:rounded-none *:[img:last-child]:rounded-none',
        className,
      )}
      {...props}
    />
